...
class Createives():
    ...
    def StandardLandingCreative(self,name,CreativeFilePath,ApiType,extlTrackerPX1,extlTrackerPX2,extlTrackerScrpt1,extlTrackerScrpt2,ThirdPrtyClkThrURL,clkThrURL,headerImagePath,HeaderClkThrurl,BtnColor,DirectionText,CallBTnLbl,phnNum,AddBtnClkThrUrl,AddBtnText,CoupnImgPath,CpnClikThrUrl,YoutubeID,FooterTitle,FooterText): #name,CreativeFilePath,ApiType,extlTrackerPX1,extlTrackerPX2,extlTrackerScrpt1,extlTrackerScrpt2,ThirdPrtyClkThrURL,headerImagePath,HeaderClkThrurl,BtnColor,phnNum,AddBtnClkThrUrl,AddBtnText,CoupnImgPath,CpnClikThrUrl,YoutubeID,FooterTitle,FooterText
        ...
        if collections.Counter(actualCreativeFooterButtons) == collections.Counter(expectedCreativeFooterButtons):
            ...
            print('Failed, buttons names under creative footer are incorrect',expectedCreativeFooterButtons)
        # testing no of checkboxed under the landing pages and their default status
        checkboxs=driver.find_elements(By.XPATH,"//ng-form[@name='landingPageForm']//input[@type='checkbox']")
        chkboxLbl=driver.find_elements(By.XPATH,"//ng-form[@name='landingPageForm']//input[@type='checkbox']//../label")
        # testing all chkbox under the landing page
        ActualDefaultChkedChkbox=['Enable Directions', 'Enable Call Button', 'Additional Button', 'Flip Coupon and Video']
        ExpectedDefaultChkedChkbox=[]
        print(len(checkboxs))
        for lbl in chkboxLbl:
            print(lbl.text)  
            ExpectedDefaultChkedChkbox.append(lbl.text)
        print(ExpectedDefaultChkedChkbox)         
        if collections.Counter(ActualDefaultChkedChkbox) == collections.Counter(ExpectedDefaultChkedChkbox):
            print('Passed, all checkbox buttons under the landing page are correct')
        else:
            print('Failed, all checkbox buttons under the landing page are incorrect',ExpectedDefaultChkedChkbox)
        
        # testing default checked checkbox
...
# cr.SuperLandingCreative("SuperLandingPage","/Users/surenderpal/Downloads/Creatives/4.jpg","ORMMA","https://ads-release-3-17-np.groundtruth.com/","https://ads-release-3-17-np.groundtruth.com/","https://ads-release-3-16-np.groundtruth.com/","https://ads-release-3-16-np.groundtruth.com/","https://www.ClikckTruoughURL.com/","https://www.ThirdPartyClikckTruoughURL.com/","/Users/surenderpal/Downloads/Creatives/640X400.jpg","https://headerClickThroughURL.com/","a61616","test Direction","Tested Call Button Label","8802406457","http://www.additionalClickThroughURL.com","AdditionalButtonText","/Users/surenderpal/Downloads/Creatives/750X704.png","https://CouponClickThroughURL.com","Uk4EiYDKVbM","Tested Disclaimer","This is a tested sample disclaimer")
sleep(20)
driver.close() 
